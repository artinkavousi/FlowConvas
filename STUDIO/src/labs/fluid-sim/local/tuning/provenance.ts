/**
 * provenance.ts — where this Lab's module snapshot came from (Lab Capsule Standard).
 */
...
export const labProvenance = {
  ...
  modules: 'verbatim snapshot under labs/fluid-sim/modules/ (Three.js r184 + TSL + WebGPU)',
