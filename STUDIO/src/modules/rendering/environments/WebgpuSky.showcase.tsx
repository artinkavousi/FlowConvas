...
import { createWebgpuSkyScene } from './WebgpuSky.module';

const BRIDGE_ID = 'webgpu-sky-mesh';

export default function WebgpuSkyShowcase() {
  const canvasRef = useRef<HTMLCanvasElement>(null);
  const engineRef = useRef<ReturnType<typeof createWebgpuSkyScene> | null>(null);
  ...
  useEffect(() => {
    ...
    const engine = createWebgpuSkyScene(canvas, {});
