...
| FR-17 | The converter shall strip unrelated scaffolding and decompose work into compact modules per the decomposition model (ARTINOS-PRD §9) without over-splitting files. | S | MVP | Converted output follows the compact module philosophy (AGENTS.md §3); no deep folder nesting or fake abstractions. |
