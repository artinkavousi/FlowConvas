...
export {
  ...
  useInspectorStore,
  formatBytes as formatInspectorBytes,
  type InspectorState,
} from './inspector';
export type {
  Backend as InspectorBackend,
  ConsoleLevel,
  ConsoleMessage,
  FrameSnapshot,
  InspectorSettings,
...
export { TelemetryPanel } from './panels/inspector/telemetry.panel';
export { StatsHud, type StatsHudProps } from './panels/inspector/widgets/StatsHud';
export { LiveGraph, type GraphSeries } from './panels/inspector/widgets/LiveGraph';
export { StatTree } from './panels/inspector/widgets/StatTree';
